package calico.plugins.IntegratedMapPlugin.iconsets;
...
public class CalicoIconManager
{
	...
	public static void setIconTheme(Class<?> clazz, String name)
	{
		...
		try
		{
			iconTheme.load( clazz.getResourceAsStream("/calico/iconsets/"+iconThemeName+"/examplepluginicontheme.properties")  );
	...
	public static BufferedImage getImagePart(Image img, int x, int y, int w, int h)
	{
		...
		JOptionPane.showMessageDialog(null,"entered get image part");
